...
from mdpath.src.structure import StructureCalculations, DihedralAngles  # Replace 'mymodule' with the actual module name
...
def test_calculate_dihedral_movement_parallel(mock_pool, mock_traj):
    angles = DihedralAngles(mock_traj, 1, 2, 1)
    mock_pool.return_value.__enter__.return_value.imap_unordered.return_value = [(1, np.array([1, 2]))]
